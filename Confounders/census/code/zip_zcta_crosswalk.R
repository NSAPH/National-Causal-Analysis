...
se_data <- read.csv("../data/census_zcta_interpolated.csv")
...
write.csv(se_data, "../datacensus_interpolated_zips.csv")
...
write.csv(se_data, "../data/census_uninterpolated_zips.csv")
