...
brfss_path <- "../raw_data/csv/csv/brfss_"
out <- NULL
...
write.csv(out, "../processed_data/brfss_confounders.csv", row.names = F)
...
write.csv(out, "../processed_data/brfss_interpolated.csv", row.names=F)
